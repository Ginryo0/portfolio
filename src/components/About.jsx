  ...
  return (
    <div className=" max-w-xl w-1/2">
      ...
      <p className={styles.sectionText}>
        Hello! My name is <span className="text-tertiary">Ahmed</span> and I am
        a <span className="text-tertiary">web developer</span>.
      </p>
      <p className={styles.sectionText}>
        I have a true passion for creating digital experiences that come to life
        on the internet.
      </p>
      <p className={styles.sectionText}>
